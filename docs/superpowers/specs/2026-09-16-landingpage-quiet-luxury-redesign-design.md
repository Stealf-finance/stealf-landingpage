...
| Section | Change |
|---|---|
| Hero | `pt-20 md:pt-32` to `pt-12 md:pt-16`, matching `/tokenomics` so both pages open at the same height; h1 to `text-4xl md:text-6xl lg:text-7xl`; screenshot gap `mt-10` to `mt-16 md:mt-20`. The radial gradient stays — it is the brief's "subtle charcoal gradient, soft lighting". |
