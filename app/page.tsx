...
export default function Home() {
  return (
    <div id="scroll-container" className="bg-black relative h-screen overflow-y-auto lg:snap-y lg:snap-mandatory scroll-smooth">
      ...
      <section id="fonctionalities" className="min-h-screen flex items-center px-6 py-20 relative snap-start">
      ...
      <section id="architecture" className="min-h-screen flex items-center px-6 py-20 snap-start">
      ...
      {/* Features Section */}
      <div className="min-h-screen flex items-center py-20 snap-start w-full">
        <Features />
      </div>

      {/* Call to Action Section */}
      <section className="min-h-screen flex items-center px-6 py-20 snap-start">
        <CallToAction />
      </section>

      {/* FAQ Section */}
      <div id="faq" className="min-h-screen flex items-center py-20 snap-start">
        <FAQ1 />
      </div>

      {/* Contact Section */}
      <section id="contact" className="min-h-screen flex flex-col justify-center px-6 py-20 relative snap-start">
